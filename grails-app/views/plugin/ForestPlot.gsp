		...
		<table class="subsettable" style="margin: 10px;width:600px; border: 0px none; border-collapse: collapse;">
			...
			<tr>
				<td align="center">
					...
					<br />
					<br />
					Select <b>one</b> categorical variable from the Navigate Concepts panel and drag it into the box. (e.g. Treatment Arm). A continuous variable may be categorized by enabling "Binning" below.
				</td>
				...
				<td align="center">
					...
					<br />
					<br />
					Select <b>two categorical variables</b> variables from the Navigate Concepts panel and drag them into the box. (e.g. Metastasis vs. No Metastasis ). A continuous variable may be categorized by enabling "Binning" below.
				</td>	
				<td id="subsetdivider" rowspan="21" valign="center" align="center" height="100%">
				<div style="margin: 15px; border: 1px solid black; background: black; width: 1px; height: 150px"></div>
				</td>
				<td align="center">
					...
					<br />
					<br />
					Select <b>one or more categorical variables</b> from the Navigate Concepts panel and drag them into the box (e.g. Race). A continuous variable may be categorized by enabling "Binning" below.
				</td>							
			</tr>
			...
			<tr>
				<td align="center">
					...
					<br />
					<br />
					Select <b>one</b> categorical variable from the Navigate Concepts panel and drag it into the box. (e.g. Placebo Arm). A continuous variable may be categorized by enabling "Binning" below.
					<br />		
					<br />								
